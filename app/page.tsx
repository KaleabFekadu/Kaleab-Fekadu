...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <section id="contact" className="contact-section"><div className="contact-copy"><span className="section-kicker">06 / CONTACT</span><h2>Let&apos;s build<br /><span className="teal">something great.</span></h2><p>Available for select freelance and contract engineering work. If you have a hard problem, an ambitious product, or just want to say hello — my inbox is open.</p><div className="contact-links"><a href="mailto:ceo@favatechnologies.com">ceo@favatechnologies.com <Arrow /></a><a href="https://www.linkedin.com/in/kaleab-fekadu/">LinkedIn <Arrow /></a><a href="https://github.com/KaleabFekadu">GitHub <Arrow /></a></div></div><form className="contact-form" onSubmit={(event) => { event.preventDefault(); setFormSent(true) }}><label>Name<input required name="name" placeholder="Your name" /></label><label>Email<input required type="email" name="email" placeholder="you@company.com" /></label><label>Message<textarea required name="message" rows={4} placeholder="Tell me about the thing you&apos;re building..." /></label><button className="button button-primary" type="submit">{formSent ? 'Message sent ✓' : 'Send message'} <Arrow /></button></form></section>
